...
public class GetAreaImage
{
	...
	{	 
        ...
        isTessellated     = new boolean[ydim][xdim];
        ...
        for(int i = 0; i < ydim; i++)
        {
        	...
        	{ 
        	    		...
        	    		(neighborPopulated[5] && neighborPopulated[7] && neighborPopulated[1]))
        	    {
        	    	...
        	    	//There's a subtlety in the order here:  we want corner cases in
        	    	//preference to side cases.
        	    ...
        	    {
        	        //Use the weighted average of the nearest neighbors.
        	    	//Like that better than bilinear interpolation in a dilation for preserving information but also creates noise.
        	    	double total_distance = 0;
        	    	for(int m = 0; m < 8; m++)
        	    	{
        ...
        int number_of_tessellated_cells    = 0;              
        for(int i = 0; i < ydim; i++)
        {
        	for(int j = 0; j < xdim; j++)
        	{
        		...
        		if(isTessellated[i][j])
        			number_of_tessellated_cells++;
        	}
        }
	    ...
	    System.out.println("The number of tessellated cells is    " + number_of_tessellated_cells);
        ...
        try 
        {  
            ImageIO.write(data_image, "jpg", new File("C:/Users/Brian Crowley/Desktop/bilinear.jpg")); 
        } 
        catch(IOException e) 
        {  
            e.printStackTrace(); 
