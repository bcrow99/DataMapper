...
public class GetDataMapGrid
{
	...
	{	 
        ...
        try 
        {  
            ImageIO.write(data_image, "jpg", new File("C:/Users/Brian Crowley/Desktop/data_map_grid.jpg")); 
        } 
        catch(IOException e) 
        {  
            e.printStackTrace(); 
