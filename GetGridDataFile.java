...
public class GetGridDataFile
{
	...
	{	 
        ...
        */
        ...
        String file_string = new String("C:/Users/Brian Crowley/Desktop/obj8grid.txt");
            
        
        
         
        /*
        for(int i = 116180; i < 116955; i++)
        {
       ...
       */
        ...
        */
        ...
        // We have the information we need and we can start polygon and line searching.
        for(int i = 0; i < ydim; i++)
        {
        	    	    	...
        	    	    	for(int p = 0; p < third_list.size(); p++)
        	    	    	{
        	    	    		for(int q = 0; q < fourth_list.size(); q++)
        	    	    		{
        	    	    		    ...
        	    	    		    if(path.contains(xcenter, ycenter)) 
        	    	    		    {
        	    	    		        ...
        	    	    		        if(Double.isNaN(cell_intensity[i][j]))
        	    	    		        	System.out.println("Value at line 760 is NaN.");
        	    		...
        	    		(neighborPopulated[5] && neighborPopulated[7] && neighborPopulated[1]))
        	    {
        	    	    ...
        	    	    for(int n = 0; n < second_list.size(); n++)
        	    	    {
        	    	    	for(int p = 0; p < third_list.size(); p++)
        	    	    	{
        	    	    		...
        	    	    		if(path.contains(xcenter, ycenter)) 
        	    	    		{
    	    	    		        ...
    	    	    		        cell_intensity[i][j] = intensity;
    	    	    		        if(Double.isNaN(cell_intensity[i][j]))
    	    	    		        	System.out.println("Value at line 944 is NaN.");
        	    	    			isInterpolated[i][j] = true;
    	    	    		        break outer;
        	    	    		}
        	    	    	}
        	    	...
        	    	if(!foundTriangle)
        	    	{
        	    	    ...
        	    	    if(first_length < second_length && first_length < third_length)
        	    	    {
        	    			...
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1010 is NaN.");
        	    			isInterpolated[i][j] = true;
        	    	    ...
        	    	    else if(second_length < first_length && second_length < third_length)
        	    	    {
        	    			...
        	    			isInterpolated[i][j] = true;
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1040 is NaN.");
        	    	    ...
        	    	    else if(third_length < first_length && third_length < second_length)
        	    	    {
        	    			...
        	    			isInterpolated[i][j] = true;
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1060 is NaN.");
        	    	    ...
        	    	    if(Double.isNaN(cell_intensity[i][j]))
	    		        	System.out.println("Value at line 1080 is NaN.");
        	    	}
        	    }
     	    	    		...
     	    	    		for(int p = 0; p < third_list.size(); p++)
     	    	    		{
     	    	    			for(int q = 0; q < fourth_list.size(); q++)
     	    	    			{
     	    	    		        ...
     	    	    		        if(path.contains(xcenter, ycenter)) 
     	    	    		        {
        	    	    		        ...
        	    	    		        cell_intensity[i][j] = intensity;
        	    	    		        if(Double.isNaN(cell_intensity[i][j]))
        	    	    		        	System.out.println("Value at line 1200 is NaN.");
     	    	    		        	isInterpolated[i][j] = true;
        	    	    		        break outer;	
     	    	    		        }
     	    	    			}
        	    		...
        	    		(neighborPopulated[6] && neighborPopulated[1] && neighborPopulated[3]))
        	    {
        	    	    ...
        	    	    for(int n = 0; n < second_list.size(); n++)
        	    	    {
        	    	    	for(int p = 0; p < third_list.size(); p++)
        	    	    	{
        	    	    		...
        	    	    		if(path.contains(xcenter, ycenter)) 
        	    	    		{
        	    	    			...
        	    	    			isInterpolated[i][j] = true;
        	    	    			if(Double.isNaN(cell_intensity[i][j]))
    	    	    		        	System.out.println("Value at line 1300 is NaN.");
    	    	    		        break outer;
        	    	    		}
        	    	    	}
        	    	    }
        	    	...
        	    	if(!foundTriangle)
        	    	{
        	    	    ...
        	    	    if(first_length < second_length && first_length < third_length)
        	    	    {
        	    			...
        	    			isInterpolated[i][j] = true;
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1370 is NaN.");
        	    	    }
        	    	    else if(second_length < first_length && second_length < third_length)
        	    	    {
        	    	    	// Get bisecting average from second line--using x2, y2 and x3, y3
        	    			...
        	    			isInterpolated[i][j] = true;
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1390 is NaN.");
        	    	    }
        	    	    else if(third_length < first_length && third_length < second_length)
        	    	    {
        	    	    	// Get bisecting average from third line--using x3, y3, x1, y1
        	    			...
        	    			isInterpolated[i][j] = true;
        	    			if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1420 is NaN.");
        	    	    } 
        	    	    else if(first_length == second_length)
        	    	    {
        	    	    	// Get x2, y2
        	    	    ...
        	    	    if(Double.isNaN(cell_intensity[i][j]))
        		        	System.out.println("Value at line 1440 is NaN.");
        	    	}
        	    		...
        	    		(neighborPopulated[3] && neighborPopulated[4]))
        	    {
                    ...
                    if(first_list.size() == 1)
                    {
                    	...
                    	if(second_list.size() == 1)
                    	{
                    		...
                    		isInterpolated[i][j] = true;
                    		if(Double.isNaN(cell_intensity[i][j]))
    	    		        	System.out.println("Value at line 1490 is NaN.");
                    	}
                    	else
                    	{
                    		...
                    		outer: for(int m = 1; m < second_list.size(); m++)
                    		{
        	    	    		...
        	    	    		if(path.contains(xcenter, ycenter)) 
        	    	    		{
    	    	    		        ...
    	    	    		        cell_intensity[i][j] = intensity;
    	    	    		        if(Double.isNaN(cell_intensity[i][j]))
    	    	    		        	System.out.println("Value at line 1530 is NaN.");
        	    	    			isInterpolated[i][j] = true;
                    		...
                    		if(!foundBoundingTriangle)
                    		{
                	    	    ...
                	    	    if(first_length < second_length && first_length < third_length)
                	    	    {
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1590 is NaN.");
                	    	    }
                	    	    else if(second_length < first_length && second_length < third_length)
                	    	    {
                	    	    	// Get bisecting average from second line--using x2, y2 and x3, y3
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1620 is NaN.");
                	    	    }
                	    	    else if(third_length < first_length && third_length < second_length)
                	    	    {
                	    	    	// Get bisecting average from third line--using x3, y3, x1, y1
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1640 is NaN.");
                	    	    } 
                	    	    else if(first_length == second_length)
                	    	    {
                	    	    	// Get x2, y2
                	    	    ...
                	    	    if(Double.isNaN(cell_intensity[i][j]))
                		        	System.out.println("Value at line 1660 is NaN.");
                    		}
                    	}
                    }
                    else
                        ...
                        if(second_list.size() == 1)	
                        {
                    		...
                    		outer: for(int m = 1; m < first_list.size(); m++)
                    		{
        	    	    		...
        	    	    		if(path.contains(xcenter, ycenter)) 
        	    	    		{
        	    	    			...
        	    	    			isInterpolated[i][j] = true;
        	    	    			if(Double.isNaN(cell_intensity[i][j]))
        	        		        	System.out.println("Value at line 1710 is NaN.");
        	    	    			foundBoundingTriangle = true;
                    		...
                    		if(!foundBoundingTriangle)
                    		{
                	    	    ...
                	    	    if(first_length < second_length && first_length < third_length)
                	    	    {
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1780 is NaN.");
                	    	    }
                	    	    else if(second_length < first_length && second_length < third_length)
                	    	    {
                	    	    	// Get bisecting average from second line--using x2, y2 and x3, y3
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1800 is NaN.");
                	    	    }
                	    	    else if(third_length < first_length && third_length < second_length)
                	    	    {
                	    	    	// Get bisecting average from third line--using x3, y3, x1, y1
                	    			...
                	    			isInterpolated[i][j] = true;
                	    			if(Double.isNaN(cell_intensity[i][j]))
                    		        	System.out.println("Value at line 1820 is NaN.");
                	    	    } 
                	    	    else if(first_length == second_length)
                	    	    {
                	    	    	// Get x2, y2
                	    	    ...
                	    	    if(Double.isNaN(cell_intensity[i][j]))
                		        	System.out.println("Value at line 1840 is NaN.");
                    		}
                        }
                        else
                        {
                        	...
                        	outer: for(int m = 1; m < first_list.size(); m++)
                    		{
                        		...
                        		for(int n = 1; n < second_list.size(); n++)
                        		{
                    		        ...
                    		        //We didn't need to do this kind of sorting and filtering
                    		        //previously because our lists all came from different quadrants.
                    		         
                    		        
                    		        //Let's check for coincidental positions that will break our interpolation.
                    		        if(x1 == x2 && x1 == x3)
                    		        	System.out.println("Coincidental positions.");
                    		        		
                    		        //Now lets figure out how the points are distributed.		
                    		        if(isVertical)
                    		        {
                    		            if(x1 < x4)
                    		            {
                    		        ...
                    		        if(path.contains(xcenter, ycenter)) 
            	    	    		{
        	    	                    ...
        	    	                    //We need to get two more points to do our bilinear interpolation.
        	    	    			    double x5, y5, x6, y6;
        	    	    			    
        	    	    			    // The precision of the data is limited by the bits in the sensor, not the range of
        	    	    			    // a double, and coincidental positions are probable even if infrequent.
        	    	    			    
        	    	    			    // Check whether or not the slope is zero.
        	    	    			    if(y1 == y2)
        	    	    			    {
        	    	    			    	double distance = top.ptSegDist(origin);
        	    	    			    	y5              = ycenter + distance;
        	    	    			    	if(Double.isNaN(y5))
        	    	    			    		System.out.println("y5 is NaN");
        	    	    			    }
        	    	    			    else
        	    	    			    {
        	    	    			    	double slope = DataMapper.getSlope(top);
        	    	    			    ...
        	    	    			    if(y3 == y4)
        	    	    			    {
        	    	    			    	double distance = bottom.ptSegDist(origin);
        	    	    			    	y6 = ycenter - distance;	 	
        	    	    			    }
        	    	    			    else
        	    	    			    { 
        	    	    			    	double slope = DataMapper.getSlope(bottom);
        	    	    			        double y_intercept = DataMapper.getYIntercept(lower_left, slope);
        	    	    			        y6 = slope * xcenter + y_intercept;
        	    	    			    }
        	    	    			    
        	    	    			    
        	    	    			    // Check whether or not slope is infinite.
        	    	    			    if(x2 != x3)
        	    	    			    {
        	    	    			        double slope = DataMapper.getSlope(right);
        	    	    			    ...
        	    	    			    if(x1 != x4)
        	    	    			    {
        	    	    			        double slope = DataMapper.getSlope(left);
        	    	    			        double y_intercept = DataMapper.getYIntercept(lower_left, slope);
        	    	    			        x6 = (ycenter - y_intercept) / slope;
        	    	    			    }
        	    	    			    else
        	    	    		        ...
        	    	    		        else
        	    	    		        {
        	    	    		        	...
        	    	    		        	if(Double.isNaN(intensity))
                	        		        	System.out.println("Value at line 2089 is NaN.");
        	    	    		        }
        	    	    		        if(second_index == 2)
        	    	    		        {
        	    	    		        	intensity += second_sample.intensity * weight2 + third_sample.intensity * weight3;
        	    	    		        	if(Double.isNaN(intensity))
                	        		        	System.out.println("Value at line 2095 is NaN.");
        	    	    		        }
        	    	    		        else
        	    	    		        {
        	    	    		        	...
        	    	    		        	if(Double.isNaN(intensity))
        	    	    		        	{
                	        		        	System.out.println("Value at line 2100 is NaN.");
                	        		        	System.out.println("Area 1 is " + area1);
                	        		        	System.out.println("Area 2 is " + area2);
                	        		        	System.out.println("Area 3 is " + area3);
                	        		        	System.out.println("Area 4 is " + area4);
                        	...
                        	if(!foundBoundingBox)
                    		{
                        	    ...
                        	    // Assuming identical distances are extremely unlikely.
                        	    int line = 0;
                        	    ...
                        	    case 4: first_endpoint   = new Line2D.Double(x4, y4, xcenter, ycenter); 
                	                    ...
                	                    else
                	                    {
                	    			        ...
                	    			        isInterpolated[i][j] = true;	
                	    			        if(Double.isNaN(cell_intensity[i][j]))
                	        		        	System.out.println("Value at line 2275 is NaN.");
                	                    }
        	                            break;
                        	    }
        ...
        for(int i = 0; i < ydim; i++)
        {
            for(int j= 0; j < xdim; j++)
            {
            	...
            	{
            		//System.out.println("Current value is not a number.");
            	}
        ...
        try(PrintWriter output = new PrintWriter(file_string))
        {     
        if(number_of_uninterpolated_cells == 0) //Go ahead and write a data file
        {	
            for(int i = 0; i < ydim; i++)
            {
                for(int j = 0; j < xdim; j++)
                {
                    ...
                    String intensity = String.valueOf(current_value);
        ...
        else
        {
        	for(int i = 0; i < ydim; i++)
            {
                for(int j = 0; j < xdim; j++)
                {
                    ...
                    String intensity = String.valueOf(current_value);
                    /*
                    if(intensity.equals("NaN"))
            	    {
            	    	System.out.println("The current value " + current_value + " is not a number.");
            	    }
            	    */
                }
            }
            ...
            while(number_of_uninterpolated_cells != 0)  //Do an image dilation.
            {
            	...
            	ImageMapper.dilateImage(src, isAssigned, xdim, ydim, dst);
