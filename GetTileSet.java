...
public class GetTileSet 
{
	public static void main(String[] args) throws IOException, FileNotFoundException 
	{
        ...
        */
		...
		int xdim                = resolution * tile_xdim;
		int ydim                = resolution * tile_ydim;
		...
		*/
		...
		boolean[][] isPopulated    = new boolean[ydim][xdim];
		boolean[][] hasNeighbors   = new boolean[ydim][xdim];
		boolean[][] isInterpolated = new boolean[ydim][xdim];
		int[][] number_of_samples      = new int[ydim][xdim];
		double[][] cell_intensity      = new double[ydim][xdim];
			...
			for (int j = 0; j < xdim; j++) {
				...
				for (int m = 0; m < 8; m++) {
					...
					if (sorted_list.size() != 0) {
						...
						// assuming they're in the correct order.
						...
						double current_increment = Double.MIN_VALUE;
						...
						for (int n = 1; n < distance_list.size(); n++) 
						{
							...
							if(current_distance == previous_distance) 
							{
								...
								current_increment += Double.MIN_VALUE;
